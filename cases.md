...
- Vous avez assisté à la réalisation de vos camarades dans la d'un exercice complexe. +1 Collaborer
...
- Vous avez pris des notes détaillées sur une nouvelle technologie et les avez partagées avec votre classe. +1 Collaborer
- Vous avez contribué activement à la résolution d'un conflit dans l'équipe. +1 Collaborer
- Vous avez conçu une présentation impressionnante pour un client fictif. +1 Conduire
- Vous avez réussi un exercice particulièrement difficile dans une matière technique. +1 Réaliser
- Vous avez organisé une séance de brainstorming très productive. +1 Conduire
- Vous avez réussi à résoudre un bug complexe avant la date limite. +1 Réaliser
- Vous avez organisé une réunion d'équipe efficace avec un plan d'action clair. +1 Conduire
...
- Vous avez perturbé un projet par manque de communication avec votre équipe. -1 Collaborer
...
- Vous avez contribué à un climat de tension au sein de l'équipe. -1 Collaborer
...
- Vous avez mal planifié les tâches à réaliser sur un projet. -1 Conduire
- Vous avez noté une échéance critique par manque d'organisation. -1 Conduire
- Vous avez négligé d'apporter le matériel requis pour un cours. -1 Administrer
- Vous avez pris du retard sur un projet à cause d'un manque de planification. -1 Conduire
- Vous avez refusé d'aider un camarade en difficulté. -1 Collaborer
...
- Vous avez contribué à un conflit dans l'équipe. -1 Collaborer
- Vous avez laissé votre équipe travailler sans participer activement. -1 Collaborer
- Vous avez perturbé le Collaborer par une mauvaise communication. -1 Collaborer
- Vous avez soumis un projet avec des bugs non résolus. -1 Réaliser
- Vous avez négligé une tâche confiée à votre chef de projet. -1 Conduire
